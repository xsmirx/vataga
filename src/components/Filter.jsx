...
export const Filter = ({
  ...
  return (
    <div className="flex justify-between py-4 border-b">
      <FormControl>
        <FormLabel id="demo-radio-buttons-group-label">Время</FormLabel>
        <RadioGroup
          aria-labelledby="demo-radio-buttons-group-label"
          defaultValue="female"
          name="radio-buttons-group"
        >
          <FormControlLabel value="1" control={<Radio />} label="30 мин" />
          <FormControlLabel value="2" control={<Radio />} label="60 мин" />
          <FormControlLabel value="3" control={<Radio />} label="120 мин" />
          <FormControlLabel value="4" control={<Radio />} label="240+ мин" />
        </RadioGroup>
      </FormControl>
      <FormControl>
        <FormLabel id="demo-radio-buttons-group-label">Сложность</FormLabel>
        <RadioGroup
          aria-labelledby="demo-radio-buttons-group-label"
          defaultValue="female"
          name="radio-buttons-group"
